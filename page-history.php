    ...
    <div class="main-content">
       ...
       <?php wp_reset_postdata(); ?> 
        ...
        <ul class="grid-gallery">
            ...
            <li><button class="gallery-btn"><img src="https://srfti.ac.in/wp-content/themes/srft-theme/images/foundation-09.jpg" alt="Construction of the Institute - elevated view of main stairway and water tank" class="single-image"></button></li>
