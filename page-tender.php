  ...
  <section class="cine-header"
    ...
    <div class="page-banner">
      <h1 class="page-banner-title">
        <?php echo esc_html__('Tender','srft-theme'); ?>
      </h1>
    </div>
  ...
  <section id="skip-to-content" class="section-home">
    ...
    <div class="container" style="padding:0 3.2rem;">
      ...
      <h2 class="page-header-text"
        ...
        <?php echo esc_html__('Tender List','srft-theme'); ?>
      ...
      <div data-ng-app="myApp">
        ...
        <div data-ng-controller="TenderController">
          ...
          <p data-ng-if="isLoading">
            <?php echo esc_html__('Loading tenders…','srft-theme'); ?>
          </p>


          <p data-ng-if="loadError"
             style="color:#b00020;">

            <?php echo esc_html__('Failed to load tenders. Please try again later.','srft-theme'); ?>
            ...
            <div class="table-container">
              ...
              <table>
                ...
                <caption class="sr-only">
                  ...
                  <?php echo esc_html__('table showing list of tender documents','srft-theme'); ?>
                ...
                <thead>
                  ...
                  <tr class="Rtable-row Rtable-row--head">
                    ...
                    <th class="Rtable-cell cell-width-10-percent column-heading"
                        scope="col">
                    ...
                    <th class="Rtable-cell cell-width-15-percent column-heading"
                        scope="col">

                      <?php echo esc_html__('Tender ID','srft-theme'); ?>

                    </th>


                    <th class="Rtable-cell cell-width-25-percent column-heading"
                        scope="col">

                      <?php echo esc_html__('Tender Title','srft-theme'); ?>
                    ...
                    <th class="Rtable-cell cell-width-10-percent column-heading"
                      ...
                      <?php echo esc_html__('Due Date','srft-theme'); ?>

                    </th>


                    <th class="Rtable-cell cell-width-20-percent column-heading"
                        scope="col">
                    ...
                    <th class="Rtable-cell cell-width-10-percent column-heading"
                      ...
                      <?php echo esc_html__('Tender Status','srft-theme'); ?>
                ...
                <tbody>
                  ...
                  <tr
                    class="Rtable-row"
                    data-ng-repeat="tender in pagedTender track by $index">
                    ...
                    <th
                      class="Rtable-cell cell-width-25-percent"
                      scope="row">
                    ...
                    <td class="Rtable-cell cell-width-10-percent">
                      ...
                      <div class="Rtable-cell--content">
                        ...
                        <span data-ng-if="!tender.subdate">—</span>
                      ...
                      <div
                        ...
                        <a
                          ...
                          <img
                            ...
                            src="<?php echo esc_url(get_template_directory_uri()); ?>/images/pdf_icon_resized.png">
                    ...
                    <td class="Rtable-cell cell-width-10-percent">
                      ...
                      <div class="Rtable-cell--content access-link-content">
                        ...
                        <p data-ng-if="tender.isSubmissionOpen">

                          <?php echo esc_html__('Open','srft-theme'); ?>

                        </p>

                        <p data-ng-if="!tender.isSubmissionOpen">

                          <?php echo esc_html__('Closed','srft-theme'); ?>
...
function fetchTenders(page,acc){
    ...
    var url =
        siteURL +
        'wp-json/wp/v2/tender?categories=' +
        categoryID +
        '&per_page=100&page=' +
        page;
...
function processTenders(allPosts){
    ...
    allPosts.map(function(post){
        ...
        var pub =
            parseDate(acf['Tender-Publish-Date']);

        var sub =
            parseDate(acf['Tender-Submission-Date']);
...
function setStatusMessage(){
    ...
    if($scope.filteredTender.length > 0){
        ...
        statusEl.textContent =
            $scope.filteredTender.length +
            " <?php echo esc_js(__('tenders found.','srft-theme')); ?>";

    }
    else{

        statusEl.textContent =
            "<?php echo esc_js(__('No tenders found.','srft-theme')); ?>";
