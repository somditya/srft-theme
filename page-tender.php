              ...
              <div class="Rtable Rtable--7cols Rtable--collapse">
                ...
                <div class="Rtable-row" ng-repeat="tender in pagedTender">
                  ...
                  <div class="Rtable-cell access-link-cell">
                    ...
                    <div class="Rtable-cell--content access-link-content"><a href="{{tender.file.url}}"><?php echo __('View', 'srft-theme' ); ?><img alt="pdf" class="pdf_icon" src="<?php echo esc_url(get_template_directory_uri()); ?>/images/pdf_icon.png">&nbsp;({{tender.file.type}} - {{tender.file.size}} MB)</a></div>
                  </div>
                  <!--<div class="Rtable-cell access-link-cell">
