...
<div class="footer_container" role="contentinfo">
  <div class="footer_inner_container">
    <div class="footer_sub">
        <img src="<?php bloginfo('template_url'); ?>/images/Srfti_logo.png" title="Logo of SRFTI" alt="Logo of SRFTI" style="padding: 10px">
    </div>
    <div class="footer_sub">
...
jQuery(function($) {
  ...
  responsive: {
    ...
    console.warn('Owl Carousel not found — you may need the fallback code');
  }
...
<script>
/*
 * W3C Accessible Tabs Implementation
 * Based on ARIA Authoring Practices
 */
'use strict';
class TabsManual {
