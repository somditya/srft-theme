...
<main>
    <section class="cine-header" style="background-image: url('<?php echo esc_url(get_the_post_thumbnail_url(get_the_ID(), 'large')); ?>');">
        <div class="page-banner">
            <div class="page-banner-title"><?php echo __('Annual Reports', 'srft-theme'); ?></div>
        </div>
    </section>
                    ...
                    if ($download_post->have_posts()) {
                        while ($download_post->have_posts()) {
                            ...
                            if ($document_category === 'Annual Report' && $document_file) {
                                ...
                                $file_size_mb = ($file_size !== false) ? size_format($file_size, 2) : 'Unknown'; // Convert file size to MB
                                ?>
