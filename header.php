  ...
  <header class="sticky" >
       ...
       <div style="display: flex; justify-content: space-between; align-items: center; width: 100%; padding: 10px 20px; background-color: white;">
        <div style="display: flex; align-items: center; flex-shrink: 0;">
          <div><a href="https://srfti.ac.in" title="Logo of SRFTI"><img class="logo1"  style="height: 6rem;" src="<?php bloginfo('template_url'); ?>/images/SRFTI_Logo_DTBU.jpg" alt="<?php echo __('Logo of SRFTI', 'srft-theme' ); ?>"></a> </div>
